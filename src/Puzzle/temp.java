 ...
 * Give the sequence of the 13 keys in the array that results after inserting the sequence of 3 keys
 ...
 98 44 96 35 40 20 25 12 30 26
 */
public class temp {

    public static void main(String[] args) {

        Integer[] arr = new Integer[]{96, 69, 80, 54, 29, 51, 55, 44, 31, 15 };
        MaxPQ<Integer> max = new MaxPQ<Integer>(arr);
        printPQ(max);
        max.delMax();
        max.delMax();
        max.delMax();
